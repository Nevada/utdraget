...
import com.nevada.utdraget.gwt.scaffold.generated.RegularUserDetailsView;
 ...
 */
public class RegularUserDetailsActivity extends AbstractActivity implements
   ...
   */
  public RegularUserDetailsActivity(String id, ApplicationRequestFactory requests,
  ...
  public RegularUserDetailsActivity(String id, ApplicationRequestFactory requests,
      PlaceController<ApplicationPlace> placeController,
      RecordDetailsView<RegularUserRecord> view) {
  ...
  public void editClicked() {
    placeController.goTo(new RegularUserScaffoldPlace(view.getValue(),
        Operation.EDIT));
  }
