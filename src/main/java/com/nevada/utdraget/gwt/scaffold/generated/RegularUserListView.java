...
public class RegularUserListView extends AbstractRecordListView<RegularUserRecord> {
  ...
  protected List<PropertyColumn<RegularUserRecord, ?>> getColumns() {
    ...
    columns.add(new PropertyColumn<RegularUserRecord, java.lang.String>(RegularUserRecord.email, new Renderer<java.lang.String>() {
      public String render(java.lang.String obj) {
        return String.valueOf(obj);
      }    
}));  
    columns.add(new PropertyColumn<RegularUserRecord, java.lang.String>(RegularUserRecord.name, new Renderer<java.lang.String>() {
      public String render(java.lang.String obj) {
        return String.valueOf(obj);
      }    
}));  
